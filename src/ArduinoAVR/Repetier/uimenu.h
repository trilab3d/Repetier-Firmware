...
// UI_MENU_CHANGEACTION_T(ui_service_diagonal_rod_length, UI_TEXT_DIAGONAL_ROD_LENGTH_ID, UI_ACTION_DIAGONAL_ROD_LENGTH)
...
UI_MENU_ACTIONCOMMAND_T(ui_menu_cal_manual_adjust, UI_TEXT_CAL_MANUAL_ADJUST_ID, UI_ACTION_CAL_MANUAL_ADJUST)
#define UI_MENU_SERVICE_CAL {UI_MENU_ADDCONDBACK &ui_menu_cal_plain_probing, &ui_menu_cal_autolevel_probing, &ui_menu_cal_run_full_calibration, &ui_menu_cal_manual_adjust}
