...
#define UI_MENU_SERVICE {UI_MENU_ADDCONDBACK SERVICE_MENU_ITEM1 SERVICE_MENU_ITEM2 SERVICE_MENU_ITEM3 SERVICE_MENU_ITEM4 SERVICE_MENU_ITEM5 ,&ui_service_diagonal_rod_length,&ui_menu_least_squares_calib}
