...
#ifdef USER_QUICK_MENU_Z_PROBE_HEIGHT_USER_CHANGE
 //UI_MENU_CHANGEACTION_T(ui_menu_z_offset_change, UI_TEXT_ZPROBE_HEIGHT_ID, UI_ACTION_Z_OFFSET_CHANGE)
...
#define Z_OFFSET_USER_CHANGE_CNT 1 
#define Z_OFFSET_USER_CHANGE ,&ui_menu_adjust_z_offset_change
#else
#define Z_OFFSET_USER_CHANGE_CNT 0
#define Z_OFFSET_USER_CHANGE
#endif

#ifdef USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_1
 UI_MENU_ACTIONCOMMAND(ui_menu_custom_script1,USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_1_TEXT,UI_ACTION_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_1)
 #define CUSTOM_SCRIPT1_CNT 1
 #define CUSTOM_SCRIPT1 ,&ui_menu_custom_script1
 #else
 #define CUSTOM_SCRIPT1_CNT 0
 #define CUSTOM_SCRIPT1
  #endif

#ifdef USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_2
UI_MENU_ACTIONCOMMAND(ui_menu_custom_script2,USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_2_TEXT,UI_ACTION_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_2)
 #define CUSTOM_SCRIPT2_CNT 1
 #define CUSTOM_SCRIPT2 ,&ui_menu_custom_script2
 #else
 #define CUSTOM_SCRIPT2_CNT 0
 #define CUSTOM_SCRIPT2
 #endif
#ifdef USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_3
  UI_MENU_ACTIONCOMMAND(ui_menu_custom_script3,USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_3_TEXT,UI_ACTION_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_3)
 #define CUSTOM_SCRIPT3_CNT 1
 #define CUSTOM_SCRIPT3 ,&ui_menu_custom_script3
 #else
 #define CUSTOM_SCRIPT3_CNT 0
 #define CUSTOM_SCRIPT3
 #endif
#ifdef USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_4
  UI_MENU_ACTIONCOMMAND(ui_menu_custom_script4,USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_4_TEXT,UI_ACTION_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_4)
 #define CUSTOM_SCRIPT4_CNT 1
 #define CUSTOM_SCRIPT4 ,&ui_menu_custom_script4
 #else
 #define CUSTOM_SCRIPT4_CNT 0
 #define CUSTOM_SCRIPT4
 #endif
#ifdef USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_5
  UI_MENU_ACTIONCOMMAND(ui_menu_custom_script5,USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_5_TEXT,UI_ACTION_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_5)
 #define CUSTOM_SCRIPT5_CNT 1
 #define CUSTOM_SCRIPT5 ,&ui_menu_custom_script5
 #else
 #define CUSTOM_SCRIPT5_CNT 0
 #define CUSTOM_SCRIPT5
 #endif
 
 
 #ifdef SERVICE_MENU
#ifdef UI_SERVICE_MENU_ITEM1 
UI_MENU_ACTIONCOMMAND(ui_service_menu_item1,SERVICE_MENU_ITEM1_TEXT,UI_ACTION_SERVICE_MENU_ITEM1)
#define UI_SERVICE_MENU_ITEM1_CNT 1
#define SERVICE_MENU_ITEM1 &ui_service_menu_item1
#else 
#define UI_SERVICE_MENU_ITEM1_CNT 0
#define SERVICE_MENU_ITEM1 
#endif	

#ifdef UI_SERVICE_MENU_ITEM2 
UI_MENU_ACTIONCOMMAND(ui_service_menu_item2,SERVICE_MENU_ITEM2_TEXT,UI_ACTION_SERVICE_MENU_ITEM2)
#define UI_SERVICE_MENU_ITEM2_CNT 1
#define SERVICE_MENU_ITEM2 ,&ui_service_menu_item2
#else 
#define UI_SERVICE_MENU_ITEM2_CNT 0
#define SERVICE_MENU_ITEM2 
#endif

#ifdef UI_SERVICE_MENU_ITEM3 
UI_MENU_ACTIONCOMMAND(ui_service_menu_item3,SERVICE_MENU_ITEM3_TEXT,UI_ACTION_SERVICE_MENU_ITEM3)
#define UI_SERVICE_MENU_ITEM3_CNT 1
#define SERVICE_MENU_ITEM3 ,&ui_service_menu_item3
#else 
#define UI_SERVICE_MENU_ITEM3_CNT 0
#define SERVICE_MENU_ITEM3 
#endif

#ifdef UI_SERVICE_MENU_ITEM4 
UI_MENU_ACTIONCOMMAND(ui_service_menu_item4,SERVICE_MENU_ITEM4_TEXT,UI_ACTION_SERVICE_MENU_ITEM4)
#define UI_SERVICE_MENU_ITEM4_CNT 1
#define SERVICE_MENU_ITEM4 ,&ui_service_menu_item4
#else 
#define UI_SERVICE_MENU_ITEM4_CNT 0
#define SERVICE_MENU_ITEM4 
#endif

#ifdef UI_SERVICE_MENU_ITEM5 
UI_MENU_ACTIONCOMMAND(ui_service_menu_item5,SERVICE_MENU_ITEM5_TEXT,UI_ACTION_SERVICE_MENU_ITEM5)
#define UI_SERVICE_MENU_ITEM5_CNT 1
#define SERVICE_MENU_ITEM5 ,&ui_service_menu_item5
#else 
#define UI_SERVICE_MENU_ITEM5_CNT 0
#define SERVICE_MENU_ITEM5 
#endif
...
UI_MENU_CHANGEACTION_T(ui_x_endstop_offset, UI_TEXT_X_ENDSTOP_OFFSET_ID, UI_ACTION_X_ENDSTOP_OFFSET)
UI_MENU_CHANGEACTION_T(ui_y_endstop_offset, UI_TEXT_Y_ENDSTOP_OFFSET_ID, UI_ACTION_Y_ENDSTOP_OFFSET)
UI_MENU_CHANGEACTION_T(ui_z_endstop_offset, UI_TEXT_Z_ENDSTOP_OFFSET_ID, UI_ACTION_Z_ENDSTOP_OFFSET)
UI_MENU_CHANGEACTION_T(ui_delta_radius, UI_TEXT_DELTA_RADIUS_ID, UI_ACTION_DELTA_RADIUS)
UI_MENU_CHANGEACTION_T(ui_x_tower_angle, UI_TEXT_X_TOWER_ANGLE_ID, UI_ACTION_X_TOWER_ANGLE)
...
UI_MENU_ACTIONCOMMAND_T(ui_reset_to_defaults, UI_TEXT_RESET_TO_DEFAULTS_ID, UI_ACTION_RESET_TO_DEFAULTS)
#define UI_MENU_CAL_MANUAL_ADJUST {UI_MENU_ADDCONDBACK &ui_x_endstop_offset, &ui_y_endstop_offset, &ui_z_endstop_offset, &ui_delta_radius, &ui_x_tower_angle, &ui_y_tower_angle, &ui_z_tower_angle, &ui_diagonal_rod_length, &ui_reset_to_defaults}
UI_MENU(ui_menu_cal_manual_adjust, UI_MENU_CAL_MANUAL_ADJUST, UI_MENU_BACKCNT + 9)
...
#define UI_MENU_SERVICE_CAL {UI_MENU_ADDCONDBACK &ui_menu_cal_plain_probing, &ui_menu_cal_autolevel_probing, &ui_menu_cal_run_full_calibration, &ui_menu_cal_manual_adjust_sub}
UI_MENU(ui_menu_service_cal, UI_MENU_SERVICE_CAL, UI_MENU_BACKCNT + 4)
...
#define UI_MENU_SERVICE {UI_MENU_ADDCONDBACK SERVICE_MENU_ITEM1 SERVICE_MENU_ITEM2 SERVICE_MENU_ITEM3 SERVICE_MENU_ITEM4 SERVICE_MENU_ITEM5 ,&ui_menu_service_cal_sub}
UI_MENU(ui_menu_service, UI_MENU_SERVICE, UI_MENU_BACKCNT + UI_SERVICE_MENU_ITEM1_CNT + UI_SERVICE_MENU_ITEM2_CNT + UI_SERVICE_MENU_ITEM3_CNT + UI_SERVICE_MENU_ITEM4_CNT + UI_SERVICE_MENU_ITEM5_CNT + 1)
UI_MENU_SUBMENU_T(ui_menu_service_sub, UI_TEXT_NA_ID , ui_menu_service)

#define UI_SERVICE_MENU ,&ui_menu_service_sub
...
#define UI_MENU_QUICK {UI_MENU_ADDCONDBACK &ui_menu_home_all BABY_ENTRY ,&ui_menu_quick_speedmultiply UI_MENU_FLOWCONF_COND \
    UI_TOOGLE_LIGHT_ENTRY UI_FANSPEED UI_FAN2SPEED UI_CHANGE_FIL_ENT UI_MENU_PREHEAT_COND Z_OFFSET_USER_CHANGE CUSTOM_SCRIPT1 CUSTOM_SCRIPT2 CUSTOM_SCRIPT3 CUSTOM_SCRIPT4 CUSTOM_SCRIPT5  UI_SERVICE_MENU ,&ui_menu_quick_origin, \
    &ui_menu_quick_stopstepper MENU_PSON_ENTRY DEBUG_PRINT_EXTRA}
UI_MENU(ui_menu_quick, UI_MENU_QUICK, 4 + Z_OFFSET_USER_CHANGE_CNT + CUSTOM_SCRIPT1_CNT + CUSTOM_SCRIPT2_CNT + CUSTOM_SCRIPT3_CNT + CUSTOM_SCRIPT4_CNT + CUSTOM_SCRIPT5_CNT + UI_MENU_SERVICE_CNT + BABY_CNT + UI_MENU_BACKCNT + MENU_PSON_COUNT + DEBUG_PRINT_COUNT + UI_MENU_FLOWCONF_CNT + UI_TOGGLE_LIGHT_COUNT + UI_CHANGE_FIL_CNT + UI_MENU_PREHEAT_CNT + UI_MENU_FAN_CNT + UI_MENU_FAN2_CNT)
