...
#define UI_MENU_SERVICE_CAL {UI_MENU_ADDCONDBACK &ui_menu_least_squares_calib}
UI_MENU(ui_menu_service_cal, UI_MENU_SERVICE_CAL, UI_MENU_BACKCNT + 1)
UI_MENU_SUBMENU_T(ui_menu_service_cal_sub, UI_TEXT_SERVICE_CAL , ui_menu_service_cal)
