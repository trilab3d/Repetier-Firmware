...
UI_MENU_ACTIONCOMMAND_T(ui_jamcontrol, UI_TEXT_JAMCONTROL_ID, UI_ACTION_TOGGLE_JAMCONTROL)

#define UI_MENU_SERVICE {UI_MENU_ADDCONDBACK SERVICE_MENU_ITEM1 SERVICE_MENU_ITEM2 SERVICE_MENU_ITEM3 SERVICE_MENU_ITEM4 SERVICE_MENU_ITEM5 ,&ui_menu_service_cal_sub, &ui_jamcontrol}
UI_MENU(ui_menu_service, UI_MENU_SERVICE, UI_MENU_BACKCNT + UI_SERVICE_MENU_ITEM1_CNT + UI_SERVICE_MENU_ITEM2_CNT + UI_SERVICE_MENU_ITEM3_CNT + UI_SERVICE_MENU_ITEM4_CNT + UI_SERVICE_MENU_ITEM5_CNT + 2)
