...
#define UI_MENU_SERVICE {UI_MENU_ADDCONDBACK SERVICE_MENU_ITEM1 SERVICE_MENU_ITEM2 SERVICE_MENU_ITEM3 SERVICE_MENU_ITEM4 SERVICE_MENU_ITEM5}
UI_MENU(ui_menu_service, UI_MENU_SERVICE, UI_MENU_BACKCNT + UI_SERVICE_MENU_ITEM1_CNT + UI_SERVICE_MENU_ITEM2_CNT + UI_SERVICE_MENU_ITEM3_CNT + UI_SERVICE_MENU_ITEM4_CNT + UI_SERVICE_MENU_ITEM5_CNT)
