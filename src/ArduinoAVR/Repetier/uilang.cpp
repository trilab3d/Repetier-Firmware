...
TRANS(UI_TEXT_X_ENDSTOP_OFFSET_EN);
TRANS(UI_TEXT_Y_ENDSTOP_OFFSET_EN);
TRANS(UI_TEXT_Z_ENDSTOP_OFFSET_EN);
TRANS(UI_TEXT_DELTA_RADIUS_EN);
TRANS(UI_TEXT_X_TOWER_ANGLE_EN);
TRANS(UI_TEXT_Y_TOWER_ANGLE_EN);
TRANS(UI_TEXT_Z_TOWER_ANGLE_EN);
TRANS(UI_TEXT_DIAGONAL_ROD_LENGTH_EN);
...
PGM_P const translations_en[NUM_TRANSLATED_WORDS+NUM_EXTRA_TRANSLATIONS] PROGMEM = {
 ...
 FUI_TEXT_X_ENDSTOP_OFFSET_EN,
 FUI_TEXT_Y_ENDSTOP_OFFSET_EN,
 FUI_TEXT_Z_ENDSTOP_OFFSET_EN,
 FUI_TEXT_DELTA_RADIUS_EN,
 FUI_TEXT_X_TOWER_ANGLE_EN,
 FUI_TEXT_Y_TOWER_ANGLE_EN,
 FUI_TEXT_Z_TOWER_ANGLE_EN,
 FUI_TEXT_DIAGONAL_ROD_LENGTH_EN,
