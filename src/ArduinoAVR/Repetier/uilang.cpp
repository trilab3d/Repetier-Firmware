...
TRANS(UI_TEXT_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_1_EN);
TRANS(UI_TEXT_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_2_EN);
TRANS(UI_TEXT_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_3_EN);
TRANS(UI_TEXT_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_4_EN);
TRANS(UI_TEXT_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_5_EN);
TRANS(UI_TEXT_SERVICE_MENU_EN);
TRANS(UI_TEXT_SERVICE_MENU_ITEM1_EN);
TRANS(UI_TEXT_SERVICE_MENU_ITEM2_EN);
TRANS(UI_TEXT_SERVICE_MENU_ITEM3_EN);
TRANS(UI_TEXT_SERVICE_MENU_ITEM4_EN);
TRANS(UI_TEXT_SERVICE_MENU_ITEM5_EN);
TRANS(UI_TEXT_SERVICE_CAL_EN);
TRANS(UI_TEXT_CAL_PLAIN_PROBING_EN);
TRANS(UI_TEXT_CAL_AUTOLEVEL_PROBING_EN);
TRANS(UI_TEXT_CAL_RUN_FULL_CALIBRATION_EN);
TRANS(UI_TEXT_CAL_MANUAL_ADJUST_EN);
TRANS(UI_TEXT_CAL_USE_TOWER_ANGLE_CORR_1_EN);
TRANS(UI_TEXT_CAL_USE_TOWER_ANGLE_CORR_2_EN);
TRANS(UI_TEXT_CAL_PROBING_RESULT_EN);
TRANS(UI_TEXT_CAL_PROBE_HEIGHT_L1_EN);
TRANS(UI_TEXT_CAL_PROBE_HEIGHT_L2_EN);
TRANS(UI_TEXT_CAL_PROBE_HEIGHT_L3_EN);
TRANS(UI_TEXT_CAL_RESULT_1_EN);
TRANS(UI_TEXT_CAL_RESULT_2_EN);
TRANS(UI_TEXT_CAL_RESULT_3_EN);
TRANS(UI_TEXT_CAL_RESULT_4_EN);
TRANS(UI_TEXT_CAL_X_ENDSTOP_OFFSET_EN);
TRANS(UI_TEXT_CAL_Y_ENDSTOP_OFFSET_EN);
TRANS(UI_TEXT_CAL_Z_ENDSTOP_OFFSET_EN);
TRANS(UI_TEXT_CAL_DELTA_RADIUS_EN);
TRANS(UI_TEXT_CAL_X_TOWER_ANGLE_EN);
TRANS(UI_TEXT_CAL_Y_TOWER_ANGLE_EN);
TRANS(UI_TEXT_CAL_Z_TOWER_ANGLE_EN);
TRANS(UI_TEXT_CAL_DIAGONAL_ROD_LENGTH_EN);
TRANS(UI_TEXT_CAL_RESET_TO_DEFAULTS_EN);
TRANS(UI_TEXT_CAL_CONFIRM_RESET_TO_DEFAULTS_EN);
TRANS(UI_TEXT_LOAD_FILAMENT_EN);
TRANS(UI_TEXT_UNLOAD_FILAMENT_EN);
TRANS(UI_TEXT_PURGE_FILAMENT_EN);
TRANS(UI_TEXT_BOWDEN_EXTRUDER_EN);
TRANS(UI_TEXT_DIRECT_EXTRUDER_EN);
TRANS(UI_TEXT_LOADING_FILAMENT_EN);
TRANS(UI_TEXT_UNLOADING_FILAMENT_EN);
TRANS(UI_TEXT_PURGING_FILAMENT_EN);
TRANS(UI_TEXT_FACTORY_RESET_EN);
TRANS(UI_TEXT_FACTORY_RESET_CONFIRM_EN);
TRANS(UI_TEXT_SERVICE_ONLY_EN);
TRANS(UI_TEXT_LINE_SEPARATOR_EN);
TRANS(UI_TEXT_Z_HOME_CALIB_EN);
TRANS(UI_TEXT_PID_TUNING_EN);
TRANS(UI_TEXT_PID_TUNING_RUNNING_EN);
...
PGM_P const translations_en[NUM_TRANSLATED_WORDS+NUM_EXTRA_TRANSLATIONS] PROGMEM = {
 ...
 FUI_TEXT_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_1_EN,
 FUI_TEXT_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_2_EN,
 FUI_TEXT_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_3_EN,
 FUI_TEXT_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_4_EN,
 FUI_TEXT_USER_QUICK_MENU_ITEM_CUSTOM_SCRIPT_5_EN,
 FUI_TEXT_SERVICE_MENU_EN,
 FUI_TEXT_SERVICE_MENU_ITEM1_EN,
 FUI_TEXT_SERVICE_MENU_ITEM2_EN,
 FUI_TEXT_SERVICE_MENU_ITEM3_EN,
 FUI_TEXT_SERVICE_MENU_ITEM4_EN,
 FUI_TEXT_SERVICE_MENU_ITEM5_EN,
 FUI_TEXT_SERVICE_CAL_EN,
 FUI_TEXT_CAL_PLAIN_PROBING_EN,
 FUI_TEXT_CAL_AUTOLEVEL_PROBING_EN,
 FUI_TEXT_CAL_RUN_FULL_CALIBRATION_EN,
 FUI_TEXT_CAL_MANUAL_ADJUST_EN,
 FUI_TEXT_CAL_USE_TOWER_ANGLE_CORR_1_EN,
 FUI_TEXT_CAL_USE_TOWER_ANGLE_CORR_2_EN,
 FUI_TEXT_CAL_PROBING_RESULT_EN,
 FUI_TEXT_CAL_PROBE_HEIGHT_L1_EN,
 FUI_TEXT_CAL_PROBE_HEIGHT_L2_EN,
 FUI_TEXT_CAL_PROBE_HEIGHT_L3_EN,
 FUI_TEXT_CAL_RESULT_1_EN,
 FUI_TEXT_CAL_RESULT_2_EN,
 FUI_TEXT_CAL_RESULT_3_EN,
 FUI_TEXT_CAL_RESULT_4_EN,
 FUI_TEXT_CAL_X_ENDSTOP_OFFSET_EN,
 FUI_TEXT_CAL_Y_ENDSTOP_OFFSET_EN,
 FUI_TEXT_CAL_Z_ENDSTOP_OFFSET_EN,
 FUI_TEXT_CAL_DELTA_RADIUS_EN,
 FUI_TEXT_CAL_X_TOWER_ANGLE_EN,
 FUI_TEXT_CAL_Y_TOWER_ANGLE_EN,
 FUI_TEXT_CAL_Z_TOWER_ANGLE_EN,
 FUI_TEXT_CAL_DIAGONAL_ROD_LENGTH_EN,
 FUI_TEXT_CAL_RESET_TO_DEFAULTS_EN,
 FUI_TEXT_CAL_CONFIRM_RESET_TO_DEFAULTS_EN,
 FUI_TEXT_LOAD_FILAMENT_EN,
 FUI_TEXT_UNLOAD_FILAMENT_EN,
 FUI_TEXT_PURGE_FILAMENT_EN,
 FUI_TEXT_BOWDEN_EXTRUDER_EN,
 FUI_TEXT_DIRECT_EXTRUDER_EN,
 FUI_TEXT_LOADING_FILAMENT_EN,
 FUI_TEXT_UNLOADING_FILAMENT_EN,
 FUI_TEXT_PURGING_FILAMENT_EN,
 FUI_TEXT_FACTORY_RESET_EN,
 FUI_TEXT_FACTORY_RESET_CONFIRM_EN,
 FUI_TEXT_SERVICE_ONLY_EN,
 FUI_TEXT_LINE_SEPARATOR_EN,
 FUI_TEXT_Z_HOME_CALIB_EN,
 FUI_TEXT_PID_TUNING_EN,
 FUI_TEXT_PID_TUNING_RUNNING_EN
...
TRANS(UI_TEXT_SERVICE_MENU_DE);
TRANS(UI_TEXT_LEAST_SQUARES_CALIB_DE);
...
PGM_P const translations_de[NUM_TRANSLATED_WORDS+NUM_EXTRA_TRANSLATIONS] PROGMEM = {
 ...
 FUI_TEXT_SERVICE_MENU_DE,
 FUI_TEXT_LEAST_SQUARES_CALIB_DE
...
TRANS(UI_TEXT_SERVICE_MENU_NL);
TRANS(UI_TEXT_LEAST_SQUARES_CALIB_NL);
...
PGM_P const translations_nl[NUM_TRANSLATED_WORDS+NUM_EXTRA_TRANSLATIONS] PROGMEM = {
 ...
 FUI_TEXT_SERVICE_MENU_NL,
 FUI_TEXT_LEAST_SQUARES_CALIB_EN
...
TRANS(UI_TEXT_SERVICE_MENU_PT);
TRANS(UI_TEXT_LEAST_SQUARES_CALIB_PT);
...
PGM_P const translations_pt[NUM_TRANSLATED_WORDS+NUM_EXTRA_TRANSLATIONS] PROGMEM = {
 ...
 FUI_TEXT_SERVICE_MENU_PT,
 FUI_TEXT_LEAST_SQUARES_CALIB_PT
...
TRANS(UI_TEXT_SERVICE_MENU_IT);
TRANS(UI_TEXT_LEAST_SQUARES_CALIB_IT);
...
PGM_P const translations_it[NUM_TRANSLATED_WORDS+NUM_EXTRA_TRANSLATIONS] PROGMEM = {
 ...
 FUI_TEXT_SERVICE_MENU_IT,
 FUI_TEXT_LEAST_SQUARES_CALIB_IT
...
TRANS(UI_TEXT_SERVICE_MENU_ES);
TRANS(UI_TEXT_LEAST_SQUARES_CALIB_ES);
...
PGM_P const translations_es[NUM_TRANSLATED_WORDS+NUM_EXTRA_TRANSLATIONS] PROGMEM = {
 ...
 FUI_TEXT_SERVICE_MENU_ES,
 FUI_TEXT_LEAST_SQUARES_CALIB_ES
...
TRANS(UI_TEXT_SERVICE_MENU_SE);
TRANS(UI_TEXT_LEAST_SQUARES_CALIB_SE);
...
PGM_P const translations_se[NUM_TRANSLATED_WORDS+NUM_EXTRA_TRANSLATIONS] PROGMEM = {
 ...
 FUI_TEXT_SERVICE_MENU_SE,
 FUI_TEXT_LEAST_SQUARES_CALIB_SE
...
TRANS(UI_TEXT_SERVICE_MENU_FR);
TRANS(UI_TEXT_LEAST_SQUARES_CALIB_FR);
...
PGM_P const translations_fr[NUM_TRANSLATED_WORDS+NUM_EXTRA_TRANSLATIONS] PROGMEM = {
 ...
 FUI_TEXT_SERVICE_MENU_FR,
 FUI_TEXT_LEAST_SQUARES_CALIB_FR
...
TRANS(UI_TEXT_SERVICE_MENU_CZ);
TRANS(UI_TEXT_LEAST_SQUARES_CALIB_CZ);
...
PGM_P const translations_cz[NUM_TRANSLATED_WORDS+NUM_EXTRA_TRANSLATIONS] PROGMEM = {
 ...
 FUI_TEXT_SERVICE_MENU_CZ,
 FUI_TEXT_LEAST_SQUARES_CALIB_CZ
...
TRANS(UI_TEXT_SERVICE_MENU_PL);
TRANS(UI_TEXT_LEAST_SQUARES_CALIB_PL);
...
PGM_P const translations_pl[NUM_TRANSLATED_WORDS+NUM_EXTRA_TRANSLATIONS] PROGMEM = {
 ...
 FUI_TEXT_SERVICE_MENU_PL,
 FUI_TEXT_LEAST_SQUARES_CALIB_PL
...
TRANS(UI_TEXT_SERVICE_MENU_TR);
TRANS(UI_TEXT_LEAST_SQUARES_CALIB_TR);
...
PGM_P const translations_TR[NUM_TRANSLATED_WORDS+NUM_EXTRA_TRANSLATIONS] PROGMEM = {
  ...
  FUI_TEXT_SERVICE_MENU_TR,
  FUI_TEXT_LEAST_SQUARES_CALIB_TR
...
TRANS(UI_TEXT_SERVICE_MENU_FI);
TRANS(UI_TEXT_LEAST_SQUARES_CALIB_FI);
...
PGM_P const translations_FI[NUM_TRANSLATED_WORDS+NUM_EXTRA_TRANSLATIONS] PROGMEM = {
  ...
  FUI_TEXT_SERVICE_MENU_FI,
 FUI_TEXT_LEAST_SQUARES_CALIB_FI
